<template>
    <div class="verb-practice">
      ...
      <!-- Kép megjelenítése a válasz helyességétől függően -->
  ...
  margin: 0;
  display: flex;
  justify-content: center; /* Középre igazítjuk vízszintesen */
  align-items: center; /* Középre igazítjuk függőlegesen */
  background-color: #ff4141; /* Egy világos háttér */
}
...
.verb-practice {
  ...
  border-radius: 20px; /* Kerekített szegélyek */
  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1); /* Árnyék hozzáadása */
}

input, button {
  width: 300px; /* 100% szélesség */
  margin: 10px;
  padding: 8px;
  font-size: 16px;
  border-radius: 30px; /* 30px border-radius */
  box-sizing: border-box; /* Padding és border figyelembevételével számol */
  display: inline-block; /* Segít egységesíteni a megjelenítést */
}

input {
  border: 2px solid #ccc; /* Alapértelmezett szegély */
}
